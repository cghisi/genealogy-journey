...
{
id: “elias-line”,
label: { en: “Elias / Maroun — Sahar’s paternal line · Mayfouk, Jbeil”, fr: “Elias / Maroun — lignée paternelle de Sahar · Mayfouk, Jbeil” }
},
{
id: “rouhana-line”,
...
"nassib-elias": {
  en: {
    ...
    sections: [
      { title: "His parents", text: "Nassib's father was Boutros Elias Maroun and his mother was Miledeh Maroun — both from the Maroun family, deeply rooted in the Maronite mountain communities of Mount Lebanon. The Maroun name recurs across multiple lines of this family, reflecting the tight endogamy typical of Maronite villages." },
  ...
  fr: {
    ...
    sections: [
      { title: "Ses parents", text: "Le père de Nassib était Boutros Elias Maroun et sa mère Miledeh Maroun — tous deux de la famille Maroun, profondément enracinée dans les communautés maronites du Mont-Liban. Le nom Maroun revient dans plusieurs lignées de cette famille, reflétant l'endogamie typique des villages maronites." },
      ...
      { title: "Jbeil / Byblos", text: "Jbeil est l'une des villes habitées en continu les plus anciennes du monde. Les Phéniciens l'appelèrent Byblos ; les Grecs nommèrent leur mot pour livre d'après son commerce de papyrus." }
    ]
  }
},

"boutros-elias-maroun": {
  en: {
    name: "Boutros Elias Maroun",
    dates: "Mayfouk, Jbeil · father of Nassib Elias",
    tags: ["Lebanese Maronite", "Mayfouk", "Gen 5"],
    sections: [
      { title: "The Maroun name", text: "Boutros Elias Maroun carries three generations in his name — a classic Maronite naming tradition. 'Boutros' (Peter) is one of the most common Maronite given names, rooted in the Apostolic tradition of the Church. 'Elias' (Elijah) is his father's name. 'Maroun' is the family surname — the same name as Saint Maron, the 4th-century Syrian monk from whom the entire Maronite Church takes its identity." },
      { title: "His parents", text: "His father was Elias Maroun. His wife was Miledeh Maroun, whose father was Emmanuel Maroun — making both parents from the Maroun family, a pattern of close-knit endogamy very common in the isolated mountain villages of Mount Lebanon." }
    ]
  },
  fr: {
    name: "Boutros Elias Maroun",
    dates: "Mayfouk, Jbeil · père de Nassib Elias",
    tags: ["Libano-Maronite", "Mayfouk", "Gén. 5"],
    sections: [
      { title: "Le nom Maroun", text: "Boutros Elias Maroun porte trois générations dans son nom — tradition maronite classique. « Boutros » (Pierre) est l'un des prénoms maronites les plus courants, ancré dans la tradition apostolique. « Elias » (Élie) est le prénom de son père. « Maroun » est le patronyme familial — le même nom que saint Maron, le moine syrien du IVe siècle dont toute l'Église maronite tire son identité." },
      { title: "Ses parents", text: "Son père était Elias Maroun. Son épouse était Miledeh Maroun, dont le père était Emmanuel Maroun — les deux parents portant le même patronyme Maroun, reflet de l'endogamie étroite très courante dans les villages de montagne isolés du Mont-Liban." }
    ]
  }
},
...
"miledeh-maroun": {
  en: {
    name: "Miledeh Maroun",
    dates: "Mayfouk, Jbeil · mother of Nassib Elias",
    tags: ["Lebanese Maronite", "Mayfouk", "Gen 5"],
    sections: [
      { title: "Her name", text: "'Miledeh' (ميلدة) is a rare and beautiful Maronite name, likely derived from the Syriac or Aramaic — meaning 'the born one' or associated with the Nativity. It is almost exclusively found in the Maronite Christian communities of Mount Lebanon, a testament to the community's ancient liturgical heritage." },
      { title: "Her family", text: "Miledeh's father was Emmanuel Maroun — sharing the Maroun surname with her husband Boutros Elias Maroun. This double Maroun connection suggests both families came from the same tightly-knit village community in Mayfouk, where such marriages between related families were common and served to preserve land and community ties." }
    ]
  },
  fr: {
    name: "Miledeh Maroun",
    dates: "Mayfouk, Jbeil · mère de Nassib Elias",
    tags: ["Libano-Maronite", "Mayfouk", "Gén. 5"],
    sections: [
      { title: "Son prénom", text: "« Miledeh » (ميلدة) est un prénom maronite rare et beau, probablement d'origine syriaque ou araméenne — signifiant « la née » ou associé à la Nativité. On le trouve presque exclusivement dans les communautés chrétiennes maronites du Mont-Liban, témoignage de l'héritage liturgique ancien de la communauté." },
      { title: "Sa famille", text: "Le père de Miledeh était Emmanuel Maroun — partageant le patronyme Maroun avec son mari Boutros Elias Maroun. Cette double connexion Maroun suggère que les deux familles venaient de la même communauté villageoise à Mayfouk, où de tels mariages entre familles apparentées étaient courants." }
    ]
  }
},
...
"elias-maroun": {
  en: {
    name: "Elias Maroun",
    dates: "Mayfouk, Jbeil · father of Boutros Elias Maroun",
    tags: ["Lebanese Maronite", "Mayfouk", "Gen 6"],
    sections: [
      { title: "Deep Maroun roots", text: "Elias Maroun represents the sixth generation of Nayla's Lebanese paternal line. 'Elias' — the Arabic form of Elijah — is one of the most revered names in the Maronite tradition, the prophet Elijah being a central figure in Syriac Christianity. His son Boutros would carry both names: Boutros Elias Maroun." },
      { title: "The Maroun family of Mayfouk", text: "The Maroun family name is one of the oldest in the Maronite tradition — derived directly from Saint Maron (350–410 AD), the Syrian hermit monk whose followers became the Maronite Church. A family bearing this name in Mayfouk, a village that sheltered Maronite Patriarchs, would have been among the most deeply rooted in the community's history." }
    ]
  },
  fr: {
    name: "Elias Maroun",
    dates: "Mayfouk, Jbeil · père de Boutros Elias Maroun",
    tags: ["Libano-Maronite", "Mayfouk", "Gén. 6"],
    sections: [
      { title: "Profondes racines Maroun", text: "Elias Maroun représente la sixième génération de la lignée paternelle libanaise de Nayla. « Elias » — la forme arabe d'Élie — est l'un des prénoms les plus vénérés dans la tradition maronite, le prophète Élie étant une figure centrale du christianisme syriaque. Son fils Boutros porterait les deux noms : Boutros Elias Maroun." },
      { title: "La famille Maroun de Mayfouk", text: "Le nom de famille Maroun est l'un des plus anciens dans la tradition maronite — dérivé directement de saint Maron (350–410 ap. J.-C.), le moine ermite syrien dont les disciples formèrent l'Église maronite. Une famille portant ce nom à Mayfouk, village qui abrita les patriarches maronites, aurait été parmi les plus profondément enracinées dans l'histoire de la communauté." }
    ]
  }
},
...
"emmanuel-maroun": {
  en: {
    name: "Emmanuel Maroun",
    dates: "Mayfouk, Jbeil · father of Miledeh Maroun",
    tags: ["Lebanese Maronite", "Mayfouk", "Gen 6"],
    sections: [
      { title: "His name", text: "'Emmanuel' (عمانوئيل) means 'God is with us' in Hebrew — one of the names of Christ in the Old Testament (Isaiah 7:14). It is a deeply Christian name, particularly cherished in the Maronite tradition which preserved its Semitic roots through Syriac liturgy. In Lebanon it is exclusively found in Christian communities." },
      { title: "The Maroun connection", text: "Emmanuel Maroun's daughter Miledeh married Boutros Elias Maroun — meaning Emmanuel and Elias Maroun (Boutros's father) were both Maroun family members whose children married each other. This inter-family marriage pattern was the foundation of mountain Maronite village life, preserving community cohesion across generations." }
    ]
  },
  fr: {
    name: "Emmanuel Maroun",
    dates: "Mayfouk, Jbeil · père de Miledeh Maroun",
    tags: ["Libano-Maronite", "Mayfouk", "Gén. 6"],
    sections: [
      { title: "Son prénom", text: "« Emmanuel » (عمانوئيل) signifie « Dieu est avec nous » en hébreu — l'un des noms du Christ dans l'Ancien Testament (Isaïe 7:14). C'est un prénom profondément chrétien, particulièrement cher dans la tradition maronite qui a préservé ses racines sémitiques à travers la liturgie syriaque. Au Liban, il se trouve exclusivement dans les communautés chrétiennes." },
      { title: "La connexion Maroun", text: "La fille d'Emmanuel Maroun, Miledeh, épousa Boutros Elias Maroun — ce qui signifie qu'Emmanuel et Elias Maroun (le père de Boutros) étaient tous deux membres de la famille Maroun dont les enfants se marièrent entre eux. Ce schéma de mariage inter-familial était le fondement de la vie villageoise maronite de montagne." }
    ]
  }
},
...
"tanious-francis": {
  en: {
    name: "Tanious Gerges Francis",
    dates: "Mayfouk, Jbeil · father of Abla Francis",
    tags: ["Lebanese Maronite", "Mayfouk", "Gen 5"],
    sections: [
      { title: "His name", text: "'Tanious' is the Maronite form of Athanasius — the great 4th-century bishop of Alexandria who defended the doctrine of Christ's divinity against the Arian heresy. The name is almost exclusively Maronite in Lebanon. 'Gerges' is the Arabic form of George — patron saint of soldiers and one of the most popular names in the Eastern Christian tradition." },
      { title: "The Francis family", text: "The Francis family name is of Latin origin — Franciscus — brought to the Levant through the centuries of Crusader and Franciscan presence in the Holy Land. In Lebanon it became a distinctly Maronite surname, carried by families who maintained their Christian identity through centuries of Ottoman rule." }
    ]
  },
  fr: {
    name: "Tanious Gerges Francis",
    dates: "Mayfouk, Jbeil · père de Abla Francis",
    tags: ["Libano-Maronite", "Mayfouk", "Gén. 5"],
    sections: [
      { title: "Son prénom", text: "« Tanious » est la forme maronite d'Athanase — le grand évêque d'Alexandrie du IVe siècle qui défendit la doctrine de la divinité du Christ contre l'hérésie arienne. Le prénom est presque exclusivement maronite au Liban. « Gerges » est la forme arabe de Georges — saint patron des soldats et l'un des prénoms les plus populaires dans la tradition chrétienne orientale." },
      { title: "La famille Francis", text: "Le nom de famille Francis est d'origine latine — Franciscus — apporté au Levant à travers les siècles de présence des Croisés et des Franciscains en Terre Sainte. Au Liban, il devint un patronyme distinctement maronite, porté par des familles qui maintinrent leur identité chrétienne à travers des siècles de domination ottomane." }
    ]
  }
},

"nissima-naoum-sassin": {
  en: {
    name: "Nissima Naoum Sassin",
    dates: "Mayfouk, Jbeil · mother of Abla Francis",
    tags: ["Lebanese Maronite", "Mayfouk", "Gen 5"],
    sections: [
      { title: "Her name", text: "'Nissima' (نسيمة) means 'gentle breeze' or 'fresh air' in Arabic — a poetic name common in Lebanese Christian communities. 'Naoum' (her father's name, carried as a middle name) means 'pleasant' or 'gentle' in Arabic, from the Hebrew Naomi. 'Sassin' is a rare Maronite surname of likely Syriac origin." },
      { title: "Three names, one identity", text: "Nissima Naoum Sassin — like many in the Lebanese Maronite tradition — carries her father's first name as her middle name, and her family surname last. This triple-name structure is a genealogical gift, embedding the paternal line directly into the name itself." }
    ]
  },
  fr: {
    name: "Nissima Naoum Sassin",
    dates: "Mayfouk, Jbeil · mère de Abla Francis",
    tags: ["Libano-Maronite", "Mayfouk", "Gén. 5"],
    sections: [
      { title: "Son prénom", text: "« Nissima » (نسيمة) signifie « brise légère » ou « air frais » en arabe — un prénom poétique courant dans les communautés chrétiennes libanaises. « Naoum » (le prénom de son père, porté comme deuxième prénom) signifie « agréable » ou « doux » en arabe, de l'hébreu Naomi. « Sassin » est un patronyme maronite rare d'origine probablement syriaque." },
      { title: "Trois noms, une identité", text: "Nissima Naoum Sassin — comme beaucoup dans la tradition maronite libanaise — porte le prénom de son père comme deuxième prénom, et le patronyme familial en dernier. Cette structure à trois noms est un cadeau généalogique, intégrant la lignée paternelle directement dans le nom lui-même." }
    ]
  }
},
